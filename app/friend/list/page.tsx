...
export default function SocialPage() {
    ...
    const fetchFollowData = async () => {
      try {
        ...
        const [followingsRes, followersRes] = await Promise.all([
          axios.get<User[]>('http://localhost:8080/api/follow/me_followings', { headers }),
          axios.get<User[]>('http://localhost:8080/api/follow/me_followers', { headers }),
        ])
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6">
      <h1 className="text-2xl font-bold mb-6">👥 나의 팔로우 현황</h1>
